...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO sport (firstname, lastname, phone, email, message) VALUES ('$firstname', '$lastname', '$phone', '$email', '$message')";
        ...
        <div class="container apply__container">
            <aside class="apply__aside">
                <div class="aside__image">
                    <img src="./images/deme2.JPG">
                </div>
                <h2>Contact</h2>
                <p>
                    Hi there, I am Demeke, I'm trying to reach out to you and I'm wondering if you could write on the best way to reach out to me. <b>Thank You For Choosing Our School.</b></p>
                <ul class="apply__details">
                    <li>
                        <i class="uil uil-phone-times"></i>
                        <h5>+251 94 87654345678</h5>
                    </li>
                    <li>
                        <i class="uil uil-envelope-times"></i>
                        <h5>demeke@gmailcom</h5>
                    </li>
                    <li>
