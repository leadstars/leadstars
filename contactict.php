...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO ictclub (firstname, lastname, phone, email, message) VALUES ('$firstname', '$lastname', '$phone', '$email', '$message')";
        ...
        <div class="container apply__container">
            <aside class="apply__aside">
                <div class="aside__image">
                    <img src="./images/contactict.png">
                </div>
                <h2>Contact</h2>
                <p>
                    Hi there, I am Flower, I'm trying to reach out to you and I'm wondering if you could write on the best way to reach out to me. <b>Thank You For Choosing Our School.</b></p>
                <ul class="apply__details">
                    <li>
                        <i class="uil uil-phone-times"></i>
                        <h5>+251 94 665 7264</h5>
                    </li>
                    <li>
