...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO spokenenglish (firstname, lastname, phone, email, message) VALUES ('$firstname', '$lastname', '$phone', '$email', '$message')";
        ...
        <div class="container apply__container">
            <aside class="apply__aside">
                <div class="aside__image">
                    <img src="./images/contactsenesa.png">
                </div>
                <h2>Contact</h2>
                <p>
                    Hi there, I am Senessa, I'm trying to reach out to you and I'm wondering if you could write on the best way to reach out to me. <b>Thank You For Choosing Our School.</b></p>
