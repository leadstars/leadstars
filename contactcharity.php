...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO charity (firstname, lastname, phone, email, message) VALUES ('$firstname', '$lastname', '$phone', '$email', '$message')";
    ...
    <section class="apply">
        <div class="container apply__container">
            <aside class="apply__aside">
                ...
                <h2>Contact</h2>
                <p>
                    Hi there, we're Charity coordinators at Leadstar Academy, we're trying to reach out to you and we're wondering if you could write on the best way to reach out to Us. <b>Thank You For Choosing Our School.</b></p>
                <ul class="apply__details">
                    <li>
                        <i class="uil uil-phone-times"></i>
                        <h5>+251 94 665 726</h5>
                    </li>
                    <li>
                        <i class="uil uil-envelope-times"></i>
                        <h5>gebnyrock@gmailcom</h5>
                    </li>
                    <li>
