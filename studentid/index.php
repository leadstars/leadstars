...
<body>
    <nav>
        <div class="container nav__container">
            <a href="../studentid/index.php" class="pada__logo"> <img src="../images/logo.png" style="width: 145px;"></a>
            <ul class="nav__menu">
                <li><a href="../index.html">Home</a></li>
                <li><a href="../about.html">About</a></li>
                <li><a href="../clubs.html">Clubs</a></li>
                <li><a href="../department.html">Department</a></li>
                <li><a href="../LAcontact.php">Contact</a></li>
                <li><a href="../gallery.html">LA. Gallery</a></li>
                <li><a href="../admin/index.php"><i class="uil uil-sign-in-alt" style="color: #0ef;"></i>Login</a></li>
            </ul>
...
<section>
    ...
    <div class="containers">
        <div class="headings">Login And Let Us Know You're Our Student<h3>For <b style="text-decoration: underline; color: #0ef;">OLD Student</b> Registration</h3></div>
        
        <form action="login.php" enctype="multipart/form-data" method="post">
            <div class="card-details">
                <div class="card-box">
                    <span class="details">Id Number <br> <small style="color: red;">* </small><small style="color: cornsilk;"> Enter Id Number</small><small style="color: red;">* </small></span>
                    <input type="text" name="uname"  placeholder="Enter Your Id Number" required>
                </div>
                <div class="card-box">
                    <span class="details">Password <br> <small style="color: red;">* </small><small style="color: cornsilk;"> Enter Password</small><small style="color: red;">* </small></span>
