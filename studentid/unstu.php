...
<section class="founder">
    ...
    <section class="ham">
        <div class="popup" id="popup">
            ...
            <p>Seems Like You've Already Registerd</p>
            <span class="details"><small style="color: red;">* </small><small style="color: cornsilk;">Click The Check Buttoon To See Your Form</small><small style="color: red;">* </small></span>
            <p>Please Try Again</p>
            <a href="indexs.php"><button type="button" onclick="closePopup()">Check</button></a>
        </div>
