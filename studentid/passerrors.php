...
<section class="founder">
    ...
    <section class="ham">
        ...
        <a href="index.php"><img src="unsuccess.png"></a>
            <h3>Sorry Something Went Wrong!!</h3>
            <p>No Student Found<b style="color: red;">!!!</b></p>
            <span class="details"><small style="color: red;">* </small><small style="color: cornsilk;">Incorrect ID Number Or Password</small><small style="color: red;">* </small></span>
            <p>Please Try Again</p>
            <a href="index.php"><button type="button" onclick="closePopup()">Try Again</button></a>
        </div>
